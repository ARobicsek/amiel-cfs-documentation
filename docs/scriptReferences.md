...
| `fix_timezone_data.js` | One-off script to recalculate and overwrite the Date and Hour columns in Health_Hourly for timestamps from different timezones. | [fix_timezone_data.js](file:///c:/Users/ariro/OneDrive/Documents/Personal/Amiel%20CFS%20documentation%20app/scripts/fix_timezone_data.js) |
| `fix_timezone_seattle.js` | One-off script to recalculate and overwrite the Timestamp, Date, and Hour columns in Health_Hourly for timestamps from the Seattle trip (-0800 offset). | [fix_timezone_seattle.js](file:///c:/Users/ariro/OneDrive/Documents/Personal/Amiel%20CFS%20documentation%20app/scripts/fix_timezone_seattle.js) |
